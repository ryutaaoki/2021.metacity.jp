		...
		<body>
			<div id="content">
				<div id="content-head">
					<h1>XML Sitemap</h1>
					<p>
						生成:  <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=liteplugin&#038;utm_medium=xml-sitemap" target="_blank">All in One SEO</a>, これはXMLサイトマップで、GoogleやBingなどの検索エンジンによって使用されることを意図しています。<br/>
